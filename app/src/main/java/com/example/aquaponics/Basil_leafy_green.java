...
public class Basil_leafy_green extends AppCompatActivity {

    TextView back, home, profile, hamburger, Lettuce, Kale, Bok_choy, cart;
    com.google.android.material.imageview.ShapeableImageView lettuce, kale, bok_choy;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.basil_leafy_greens);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Basil_leafy_green.this, LeafyGreens.class));
            }
        });
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Basil_leafy_green.this,Homepage.class));
            }
        });
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Basil_leafy_green.this,CustomerProfile.class));
            }
        });
        ...
        hamburger.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Basil_leafy_green.this,hamburger.class));
            }
        });
        ...
        Kale.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Basil_leafy_green.this,Kale_leafy_green.class));
            }
        });
        ...
        Lettuce.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Basil_leafy_green.this,Lettuce_leafy_green.class));
            }
        });
        ...
        Bok_choy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Basil_leafy_green.this,Bok_choy_leafy_green.class));
            }
        });
        ...
        add_to_cart1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Basil_leafy_green.this, Customer_order_listing.class));
            }
        });
