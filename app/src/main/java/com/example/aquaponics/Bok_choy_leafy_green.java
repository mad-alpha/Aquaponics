...
public class Bok_choy_leafy_green extends AppCompatActivity {

    TextView back, home, profile, hamburger, Lettuce, Kale, Basil, cart;
    com.google.android.material.imageview.ShapeableImageView lettuce, kale, basil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bok_choy_leafy_greens);
        ...
        add_to_cart3 = findViewById(R.id.add_to_cart_pdt1);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Bok_choy_leafy_green.this, LeafyGreens.class));
            }
        });
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Bok_choy_leafy_green.this,Homepage.class));
            }
        });
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Bok_choy_leafy_green.this,CustomerProfile.class));
            }
        });
        ...
        hamburger.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Bok_choy_leafy_green.this,hamburger.class));
            }
        });
        ...
        Kale.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Bok_choy_leafy_green.this,Kale_leafy_green.class));
            }
        });
        ...
        Lettuce.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Bok_choy_leafy_green.this,Lettuce_leafy_green.class));
            }
        });
        ...
        Basil.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Bok_choy_leafy_green.this,Basil_leafy_green.class));
            }
        });
        ...
        add_to_cart1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Bok_choy_leafy_green.this, Customer_order_listing.class));
            }
        });
